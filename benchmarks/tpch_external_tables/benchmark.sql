-- TPCH External Tables Benchmark Queries
-- Comprehensive benchmark queries for customer, lineitem, products, events, orders tables

-- Query 1: Customer Analysis - Basic aggregation on customer table
SELECT 
    COUNT(*) as total_customers,
    COUNT(DISTINCT custkey) as unique_customers,
    AVG(CAST(acctbal AS DECIMAL(10,2))) as avg_account_balance,
    MIN(CAST(acctbal AS DECIMAL(10,2))) as min_account_balance,
    MAX(CAST(acctbal AS DECIMAL(10,2))) as max_account_balance
FROM customer;
...
SELECT 
    ...
    SUM(CAST(totalprice AS DECIMAL(10,2))) as total_revenue,
    AVG(CAST(totalprice AS DECIMAL(10,2))) as avg_order_value,
...
SELECT 
    ...
    SUM(CAST(l_extendedprice AS DECIMAL(10,2))) as total_extended_price,
...
SELECT 
    ...
    SUM(CAST(o.totalprice AS DECIMAL(10,2))) as total_revenue,
    AVG(CAST(o.totalprice AS DECIMAL(10,2))) as avg_order_value
FROM customer c
...
-- Query 6: Events Analysis - Testing events table (assuming it has timestamp/date columns)
SELECT 
...
SELECT 
    ...
    SUM(CAST(l.l_extendedprice AS DECIMAL(10,2))) as total_revenue,
...
SELECT 
    ...
    COUNT(DISTINCT o.orderkey) as order_count,
    SUM(CAST(o.totalprice AS DECIMAL(10,2))) as monthly_revenue,
    AVG(CAST(o.totalprice AS DECIMAL(10,2))) as avg_order_value
FROM orders o
